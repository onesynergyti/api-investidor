...
namespace API_Investidor.Services
{
    ...
    {
        void GerarCodigo(LoginAskCode dados);

        TokenInformation ValidarCodigo(LoginCheckCode dados);
    }
    ...
    public class LoginService : RootService, ILoginService
    {
        ...
        public void GerarCodigo(LoginAskCode dados)
        {
            var cliente = _clientesRepository.GetClientePorTelefone(dados.Telefone);
        }

        public TokenInformation ValidarCodigo(LoginCheckCode dados)
        {
            var cliente = _clientesRepository.GetClientePorTelefone(dados.Telefone);
